...
const headlineList: ArchetypeDef = {
  ...
  slots: [
    ...
    { id: 'date', role: 'date', placeholder: 'AUG 2026',
      text: { family: 'display', weight: 800, size: 100, tracking: -0.02, leading: 0.9, align: 'left', fit: 'auto' } },
  ...
  variants: [
    ...
    // Variant 1: image on top, headline + date bottom-left, list bottom-right
    {
      headline: { c: 0, cs: 7, r: 10, rs: 3 },
      date:     { c: 0, cs: 7, r: 13, rs: 2 },
      list:     { c: 8, cs: 4,  r: 10, rs: 5 },
      image:    { c: 0, cs: 12, r: 0,  rs: 9 },
    },
  ],
}
